...
namespace UrlShortener.Database.MongoDB.DatabaseInitializer;

public class MongoDBSQLUrlShortenerDatabaseInitializer(ISQLHelper sqlHelper) : IUrlShortenerDatabaseInitializer
{
